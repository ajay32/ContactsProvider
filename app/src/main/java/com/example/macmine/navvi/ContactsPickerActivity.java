...
import com.example.macmine.navvi.R;
...
//    String pid=getIntent().getStringExtra("pid");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            //     Toast.makeText(ContactsPickerActivity.this,""+e, Toast.LENGTH_SHORT).show();
        }
        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(ContactsPickerActivity.this,DisplayContacts.class);
                intent.putExtra("pid",pid);
                intent.putParcelableArrayListExtra("SelectedContacts", contactsListAdapter.selectedContactsList.contactArrayList);
                ...
                if(contactsListAdapter.selectedContactsList.contactArrayList.isEmpty()){
                    ...
                    Toast.makeText(ContactsPickerActivity.this, contactsListAdapter.selectedContactsList.contactArrayList.toString(), Toast.LENGTH_SHORT).show();
